...
public class MonitorInstance {
    ...
    private List<MvtmMonitor> mvtms;
    ...
    public List<MvtmMonitor> getMvtms() {
        return mvtms;
    }

    public void setMvtms(List<MvtmMonitor> mvtms) {
        this.mvtms = mvtms;
    }

    public List<AgentMonitor> getAgents() {
        return agents;
    }

    public void setAgents(List<AgentMonitor> agents) {
        this.agents = agents;
    }
